    ...
    return (
        <Section className="flex max-md:flex-col items-start gap-4">
            <div className="flex-[3] w-full flex flex-col gap-2">
                ...
                <p className="text-justify">💻 Passionnée par la création d&apos;expériences numériques innovantes, je conçois et développe des &apos; performantes en utilisant les dernières technologies.</p>
